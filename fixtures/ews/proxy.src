...
type InstalledAppType struct {
	...
	TrialExpirationDate soap.XSDDateTime `xml:"TrialExpirationDate,omitempty" json:"TrialExpirationDate,omitempty"`
...
type ReminderType struct {
	...
	ReminderTime soap.XSDDateTime `xml:"ReminderTime,omitempty" json:"ReminderTime,omitempty"`
...
type AttachmentType struct {
	...
	LastModifiedTime soap.XSDDateTime `xml:"LastModifiedTime,omitempty" json:"LastModifiedTime,omitempty"`
...
type ItemType struct {
	...
	DateTimeReceived soap.XSDDateTime `xml:"DateTimeReceived,omitempty" json:"DateTimeReceived,omitempty"`
	...
	DateTimeSent soap.XSDDateTime `xml:"DateTimeSent,omitempty" json:"DateTimeSent,omitempty"`

	DateTimeCreated soap.XSDDateTime `xml:"DateTimeCreated,omitempty" json:"DateTimeCreated,omitempty"`

	ResponseObjects *NonEmptyArrayOfResponseObjectsType `xml:"ResponseObjects,omitempty" json:"ResponseObjects,omitempty"`

	ReminderDueBy soap.XSDDateTime `xml:"ReminderDueBy,omitempty" json:"ReminderDueBy,omitempty"`

	ReminderIsSet bool `xml:"ReminderIsSet,omitempty" json:"ReminderIsSet,omitempty"`

	ReminderNextTime soap.XSDDateTime `xml:"ReminderNextTime,omitempty" json:"ReminderNextTime,omitempty"`
	...
	RetentionDate soap.XSDDateTime `xml:"RetentionDate,omitempty" json:"RetentionDate,omitempty"`
...
type ConversationActionType struct {
	...
	ConversationLastSyncTime soap.XSDDateTime `xml:"ConversationLastSyncTime,omitempty" json:"ConversationLastSyncTime,omitempty"`
...
type ConversationType struct {
	...
	LastDeliveryTime soap.XSDDateTime `xml:"LastDeliveryTime,omitempty" json:"LastDeliveryTime,omitempty"`

	GlobalLastDeliveryTime soap.XSDDateTime `xml:"GlobalLastDeliveryTime,omitempty" json:"GlobalLastDeliveryTime,omitempty"`
...
type PeopleTokenType struct {
	...
	ExpirationDateTime soap.XSDDateTime `xml:"ExpirationDateTime,omitempty" json:"ExpirationDateTime,omitempty"`
...
type PersonaType struct {
	...
	LastContactedDate soap.XSDDateTime `xml:"LastContactedDate,omitempty" json:"LastContactedDate,omitempty"`
...
type MeetingRegistrationResponseObjectType struct {
	*WellKnownResponseObjectType
	...
	ProposedStart soap.XSDDateTime `xml:"ProposedStart,omitempty" json:"ProposedStart,omitempty"`

	ProposedEnd soap.XSDDateTime `xml:"ProposedEnd,omitempty" json:"ProposedEnd,omitempty"`
}
...
type TaskType struct {
	...
	*ItemType
	...
	AssignedTime soap.XSDDateTime `xml:"AssignedTime,omitempty" json:"AssignedTime,omitempty"`
...
type PostItemType struct {
	...
	*ItemType
	...
	PostedTime soap.XSDDateTime `xml:"PostedTime,omitempty" json:"PostedTime,omitempty"`
...
type CalendarViewType struct {
	...
	StartDate soap.XSDDateTime `xml:"http://schemas.microsoft.com/exchange/services/2006/types StartDate,attr,omitempty" json:"StartDate,omitempty"`

	EndDate soap.XSDDateTime `xml:"http://schemas.microsoft.com/exchange/services/2006/types EndDate,attr,omitempty" json:"EndDate,omitempty"`
}
...
type AttendeeType struct {
	...
	LastResponseTime soap.XSDDateTime `xml:"LastResponseTime,omitempty" json:"LastResponseTime,omitempty"`
...
type OccurrencesRangeType struct {
	...
	Start soap.XSDDateTime `xml:"http://schemas.microsoft.com/exchange/services/2006/types Start,attr,omitempty" json:"Start,omitempty"`

	End soap.XSDDateTime `xml:"http://schemas.microsoft.com/exchange/services/2006/types End,attr,omitempty" json:"End,omitempty"`
...
type OccurrenceInfoType struct {
	...
	End soap.XSDDateTime `xml:"End,omitempty" json:"End,omitempty"`

	OriginalStart soap.XSDDateTime `xml:"OriginalStart,omitempty" json:"OriginalStart,omitempty"`
}
...
type CalendarItemType struct {
	...
	*ItemType
	...
	RecurrenceId soap.XSDDateTime `xml:"RecurrenceId,omitempty" json:"RecurrenceId,omitempty"`

	DateTimeStamp soap.XSDDateTime `xml:"DateTimeStamp,omitempty" json:"DateTimeStamp,omitempty"`
	...
	AppointmentReplyTime soap.XSDDateTime `xml:"AppointmentReplyTime,omitempty" json:"AppointmentReplyTime,omitempty"`
	...
	StartWallClock soap.XSDDateTime `xml:"StartWallClock,omitempty" json:"StartWallClock,omitempty"`

	EndWallClock soap.XSDDateTime `xml:"EndWallClock,omitempty" json:"EndWallClock,omitempty"`
...
type NetworkItemType struct {
	...
	*ItemType
	...
	PsaLastChanged soap.XSDDateTime `xml:"PsaLastChanged,omitempty" json:"PsaLastChanged,omitempty"`
	...
	TokenRefreshLastAttempted soap.XSDDateTime `xml:"TokenRefreshLastAttempted,omitempty" json:"TokenRefreshLastAttempted,omitempty"`

	TokenRefreshLastCompleted soap.XSDDateTime `xml:"TokenRefreshLastCompleted,omitempty" json:"TokenRefreshLastCompleted,omitempty"`
	...
	LastSync soap.XSDDateTime `xml:"LastSync,omitempty" json:"LastSync,omitempty"`
}
...
type ContactItemType struct {
	...
	*ItemType
	...
	Birthday soap.XSDDateTime `xml:"Birthday,omitempty" json:"Birthday,omitempty"`
	...
	WeddingAnniversary soap.XSDDateTime `xml:"WeddingAnniversary,omitempty" json:"WeddingAnniversary,omitempty"`
...
type SuggestionsViewOptionsType struct {
	...
	CurrentMeetingTime soap.XSDDateTime `xml:"CurrentMeetingTime,omitempty" json:"CurrentMeetingTime,omitempty"`
...
type Suggestion struct {
	MeetingTime soap.XSDDateTime `xml:"MeetingTime,omitempty" json:"MeetingTime,omitempty"`
...
type ApprovalRequestDataType struct {
	...
	ApprovalDecisionTime soap.XSDDateTime `xml:"ApprovalDecisionTime,omitempty" json:"ApprovalDecisionTime,omitempty"`
}
...
type FindMessageTrackingSearchResultType struct {
	...
	SubmittedTime soap.XSDDateTime `xml:"SubmittedTime,omitempty" json:"SubmittedTime,omitempty"`
...
type MessageTrackingReportType struct {
	...
	SubmitTime soap.XSDDateTime `xml:"SubmitTime,omitempty" json:"SubmitTime,omitempty"`
...
type SearchPreviewItemType struct {
	...
	CreatedTime soap.XSDDateTime `xml:"CreatedTime,omitempty" json:"CreatedTime,omitempty"`

	ReceivedTime soap.XSDDateTime `xml:"ReceivedTime,omitempty" json:"ReceivedTime,omitempty"`

	SentTime soap.XSDDateTime `xml:"SentTime,omitempty" json:"SentTime,omitempty"`
...
type NonIndexableItemDetailType struct {
	...
	LastAttemptTime soap.XSDDateTime `xml:"LastAttemptTime,omitempty" json:"LastAttemptTime,omitempty"`
...
type DeletedOccurrenceStateDefinitionType struct {
	...
	*BaseCalendarItemStateDefinitionType
	...
	OccurrenceDate soap.XSDDateTime `xml:"OccurrenceDate,omitempty" json:"OccurrenceDate,omitempty"`
...
type EntityFeedbackEntryType struct {
	...
	ClientEventTimeUtc soap.XSDDateTime `xml:"ClientEventTimeUtc,omitempty" json:"ClientEventTimeUtc,omitempty"`

	ClientEventTimeLocal soap.XSDDateTime `xml:"ClientEventTimeLocal,omitempty" json:"ClientEventTimeLocal,omitempty"`
...
type InsightItemType struct {
	...
	StartTimeUtc soap.XSDDateTime `xml:"StartTimeUtc,omitempty" json:"StartTimeUtc,omitempty"`

	EndTimeUtc soap.XSDDateTime `xml:"EndTimeUtc,omitempty" json:"EndTimeUtc,omitempty"`
...
type GetPasswordExpirationDateResponseMessageType struct {
	...
	*ResponseMessageType
	...
	PasswordExpirationDate soap.XSDDateTime `xml:"PasswordExpirationDate,omitempty" json:"PasswordExpirationDate,omitempty"`
}
...
type GetRemindersType struct {
	...
	BeginTime soap.XSDDateTime `xml:"BeginTime,omitempty" json:"BeginTime,omitempty"`
...
type FindAvailableMeetingTimesType struct {
	...
	SearchWindowStart soap.XSDDateTime `xml:"SearchWindowStart,omitempty" json:"SearchWindowStart,omitempty"`
...
type GetLastPrivateCatalogUpdateResponseType struct {
	...
	*ResponseMessageType
	...
	LastUpdate soap.XSDDateTime `xml:"LastUpdate,omitempty" json:"LastUpdate,omitempty"`
...
func NewExchangeServicePortType(client *soap.Client) ExchangeServicePortType {
